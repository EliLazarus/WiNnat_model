...
CH4_taxrate = 282.885#<=target for all CH4# CO2_taxrate = 45.271#<=re target w oilgas multi
    # CO2_taxrate = ?21#22 #~ value for optimum combimation, all CH4, no GWP, 1x oil/gas, w abatement
    # CH4_taxrate = ?100#119 #~ value for optimum combimation, all CH4, no GWP, 1x oil/gas, w abatement
